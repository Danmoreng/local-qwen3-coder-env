...
$KnownModels = @(
    @{ Name = "Qwen3.8-27B (Dense) - UD-IQ3_XXS (16GB recommended)"; Url = "https://huggingface.co/unsloth/Qwen3.8-27B-GGUF/resolve/27af057ecb382ddfea5d12837360a8980560e3ed/Qwen3.8-27B-UD-IQ3_XXS.gguf"; Alias = "unsloth/Qwen3.8-27B-UD-IQ3_XXS"; Ctx = 98304; Filename = "Qwen3.8-27B-UD-IQ3_XXS-Dynamic3-27af057.gguf"; MmprojUrl = "https://huggingface.co/unsloth/Qwen3.8-27B-GGUF/resolve/27af057ecb382ddfea5d12837360a8980560e3ed/mmproj-BF16.gguf"; MmprojFilename = "mmproj-Qwen3.8-27B.gguf"; Shards = 1 },
